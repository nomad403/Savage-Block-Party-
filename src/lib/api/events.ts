...
export async function getAllEvents(): Promise<EventItem[]> {
    try {
        ...
        // 1) Local JSON uniquement si Shotgun n'est pas configuré (Node uniquement — pas de fs sur Edge / Workers)
        if (!shotgunConfigured) {
            try {
                ...
                /* Edge / Workers : pas de fs ; fichier absent ; ignorer et utiliser les APIs */
            }
        }
