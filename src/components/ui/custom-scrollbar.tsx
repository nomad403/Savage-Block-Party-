...
export default function CustomScrollbar() {
  ...
  const { isHome, isAgenda, isShop } = usePageContext();
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (isShop && scrollContainerRef.current instanceof HTMLElement) {
  ...
  }, [isScrollable, windowHeight, isShop]);
  ...
  if (isShop && typeof window !== 'undefined') {
      ...
      <div className="custom-scrollbar-track">
        <div 
          ...
          style={{
            ...
            backgroundColor: '#000000', // Toujours noir pour les éléments permanents
          }}
        />
      </div>
    </div>
