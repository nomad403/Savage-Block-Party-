...
export default function Footer() {
	...
	return (
		<footer className={`container-px py-4 ${pathname === "/" ? "fixed bottom-0 left-0 right-0 z-30" : ""}`}>
			<div className="flex items-center justify-between text-sm text-yellow-400 font-text font-normal">
				{/* Réseaux sociaux */}
				<div className="flex items-center gap-5">
					<a aria-label="Instagram" href="#" className="hover:text-yellow-300 transition-colors" target="_blank" rel="noopener noreferrer">
					...
					<a aria-label="Facebook" href="#" className="hover:text-yellow-300 transition-colors" target="_blank" rel="noopener noreferrer">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
					...
					<a aria-label="SoundCloud" href="https://soundcloud.com/savageblockpartys" className="hover:text-yellow-300 transition-colors" target="_blank" rel="noopener noreferrer">
				...
				{/* Crédit dev */}
				<div>
					<a href="https://nomad403.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-300 transition-colors">
						crafted by nomad403
					</a>
				</div>
			</div>
